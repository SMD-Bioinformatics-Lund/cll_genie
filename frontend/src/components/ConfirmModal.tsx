...
export function ConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-md rounded-2xl bg-white shadow-2xl dark:bg-[#202020] border border-neutral-200 dark:border-[#3b3732] overflow-hidden flex flex-col">
        <div className="flex items-start gap-4 p-6">
          ...
          <div className="flex-1 pt-1">
            <h3 className="text-lg font-semibold text-neutral-900 dark:text-[#f4efe8] mb-2">
              {title}
            </h3>
            <p className="text-sm text-neutral-600 dark:text-[#c7beb4]">
              {message}
            </p>
          </div>
          <button
            onClick={onCancel}
            className="flex-shrink-0 -mr-2 -mt-2 rounded-full p-2 text-neutral-400 hover:bg-neutral-100 hover:text-neutral-600 dark:hover:bg-[#2a2724] dark:hover:text-neutral-300 transition-colors"
          >
            <X size={20} />
          </button>
        </div>
